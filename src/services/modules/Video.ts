...
export class Video {
    ...
    @Get({url: 'http://localhost:8080/social-api/api/video/:id'})
    static async findVideo(id: any) {
    }

    @Post({url: 'http://localhost:8080/social-api/api/video'})
    static async insertVideo(data: any = {}) {
        return data
    }

    @Put({url: 'http://localhost:8080/social-api/api/video/:id'})
    static async updateVideo(id: any, data: any = {}) {
        console.log(id, data)
        return data
    }

    @Delete({url: 'http://localhost:8080/social-api/api/video/:id'})
