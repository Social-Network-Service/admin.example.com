...
const components = {
    ...
    '/AntDesign/Form': wrapComponent(lazy(() => import('@/pages/AntDesign/Form/Form/index'))),
    '/AntDesign/Select': wrapComponent(lazy(() => import('@/pages/AntDesign/Form/Select/index'))),
    '/AntDesign/Checkbox': wrapComponent(lazy(() => import('@/pages/AntDesign/Form/Checkbox/index'))),
    '/AntDesign/Input': wrapComponent(lazy(() => import('@/pages/AntDesign/Form/Input/index'))),
    '/AntDesign/Upload': wrapComponent(lazy(() => import('@/pages/AntDesign/Form/Upload/index'))),
    ...
    '/Demo/CRUD/Analysis': wrapComponent(lazy(() => import('@/pages/Demo/CRUD/Analysis/index'))),
